...
class PairedPatchDataset(Dataset):
    ...
    def __init__(self, datasets, patch_ratio, on_the_fly=True, patch_size=1000, num_patches=1000, transform=None):
        ...
        self.len_datasets = sum([len(dset) for dset in datasets])  # 120
    ...
    def __getitem__(self, idx):
        if self.on_the_fly:
            # random select a dataset of three datasets
            pcl_dset = random.choice(self.datasets)
            # get a data from this dataset
