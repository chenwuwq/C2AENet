...
class Evaluator(object):
    ...
    def __init__(self, output_pcl_dir, dataset_root, dataset, summary_dir, experiment_name, device='cuda',
...
class Evaluator_Kinect(object):
    ...
    def __init__(self, output_pcl_dir, dataset_root, dataset, summary_dir, experiment_name, device='cuda',
        ...
        self.summary_dir = summary_dir
        self.experiment_name = experiment_name
        self.gts_pcl_dir = os.path.join(dataset_root, 'test', 'original_xyz')
        self.gts_mesh_dir = os.path.join(dataset_root, 'test', 'original_mesh')
        self.device = device
        self.logger = logger
        self.load_data()
